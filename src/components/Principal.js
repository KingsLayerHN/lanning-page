                    ...
                    <div className="container ">
                        <div className="row align-items-center">
                            <div className="col-12 col-md-10 col-sm-8 col-lg-6 mx-auto text-center">
                                ...
                                <button className="btn btn-success btn-lg mx-1" type="button">Get Started</button>
                                <button className="btn btn-outline-light btn-lg mx-1" type="button">Components</button>
                            </div>
                        </div>
                    </div>
                </div>
